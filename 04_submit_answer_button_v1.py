# Based on 03_getting_answer_input_v3_trial2.py: Using the easy button and
# easy questions first

# Changing the Multiple Choice Labels into Buttons.
# Made a Submit Answer Function to create the submit button and having it
# command to a test answer function.

# As the multiple choice buttons is pressed, a submit button should appear.
# When submit button is clicked, the program will print "submitted" in python.
...
def get_answer(difficulty, correct, random1, random2, random3):
    if difficulty == "Easy":
        ...
        correct_choice = Button(root, bg="black", fg="white",
                                text=correct_month,
                                font=("Arial", 17), command=submit_answer)
...
def submit_answer():
    submit_button = Button(root, bg="blue", fg="white", text="Submit",
                           font=("Arial", 20), command=test_answer)
