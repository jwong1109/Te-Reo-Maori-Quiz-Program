# Acting on the suggestions and feedback from usability testing:

# Give user the option to see the list of 12 months with English and Maori
# before doing the quiz.

# For the easy quiz: getting rid of the submit button when user selects
# multiple choice.

# Create a Button to go back to the main menu anytime
