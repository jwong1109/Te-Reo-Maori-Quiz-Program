# Submitting answer for hard questions. To get answer selected from dropdown
# and the submit button be able to print in python the answer pressed,
# correct answer, and the mark for hard questions
